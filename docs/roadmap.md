...
- Eighty passing probes — seventy-six in the first-party pack `packs/lodestar-core/` (full list in [`reference/probe-packs.md`](reference/probe-packs.md); the foundational set:)
