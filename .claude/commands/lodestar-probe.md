...
1. Locate the probe under `packs/lodestar-core/probes/` matching the name (case-insensitive, with or without `.ts` extension).
...
5. Execute the probe (use `bun run packs/lodestar-core/probes/<name>.ts`).
